-- Example database filename: sdr_session_20241229_153022.db
...
CREATE TABLE session_info (
    ...
    config_json TEXT,              -- Additional session config
...
CREATE TABLE samples (
    ...
    power REAL NOT NULL,          -- Signal power in dBm
    num_samples INTEGER,          -- Number of samples in bin (NULL for HackRF)
